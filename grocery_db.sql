...
DROP TABLE IF EXISTS `booked_item`;
...
LOCK TABLES `booked_item` WRITE;
/*!40000 ALTER TABLE `booked_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `booked_item` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-11-03  1:00:49
